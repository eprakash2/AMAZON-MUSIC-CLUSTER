...
def load_data():
    ...
    try:
        df = pd.read_csv('amazon_music_clusters_with_all_methods.csv')
        ...
        st.error("File 'amazon_music_clusters_with_all_methods.csv' not found. Please ensure it's in the same folder as this script.")
        st.stop()
...
with col1:
    ...
    Built with using Streamlit, Plotly, and Scikit-learn.
    """)
